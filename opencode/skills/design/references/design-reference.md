...
Before writing the first component, name the single CSS strategy for the project and stick to it. Do not mix multiple styling systems without an explicit reason and boundary.
