## English Coaching For OpenCode

Use this as a manual instruction template for OpenCode.

If your OpenCode host supports a global instruction or profile prompt, paste this there. If it only supports per-session instructions, paste it at session start. This repo does not currently claim a verified always-on injection point for this behavior in OpenCode.
